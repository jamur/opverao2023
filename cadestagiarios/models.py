...
class Atividade(models.Model):
    conjatividade = models.ForeignKey(ConjAtividade, on_delete=models.SET_NULL, null=True)
...
class AtividadeEspecifica(models.Model):
    conjatividade = models.ForeignKey(ConjAtividadeEspecifica, on_delete=models.SET_NULL, null=True)
    atividade = models.TextField()
...
class ConjConjAtividades(models.Model):
    descricaoounome = models.CharField('Descrição', max_length=25)
    atividadesdoprojeto = models.ForeignKey(ConjAtividade, on_delete=models.SET_NULL, null=True)
    atividadesdafuncao = models.ForeignKey(ConjAtividadeEspecifica, on_delete=models.SET_NULL, null=True)
    #atividadesdocurso = models.ForeignKey(ConjAtividade, on_delete=models.SET_NULL, null=True)
...
class Estagiario(models.Model):
    ...
    subprojeto = models.ForeignKey(SubProjeto, on_delete=models.SET_NULL, null=True, blank=True)
    ...
    end_cidade = models.ForeignKey(Cidade, on_delete=models.SET_NULL, null=True, blank=True)
    end_estado = models.ForeignKey(Estado, on_delete=models.SET_NULL, null=True, blank=True)
    conj_atividades = models.ForeignKey(ConjAtividade, on_delete=models.SET_NULL, null=True, blank=True)
    ...
    instituicao_de_ensino = models.ForeignKey(InstituicaoDeEnsino, on_delete=models.SET_NULL, null=True, blank=True)
...
class Documento(models.Model):
    ...
    tipo_de_documento = models.ForeignKey(TipoDeDocumento, on_delete=models.SET_NULL, null=True, blank=True)
    local_atual = models.ForeignKey(Local, on_delete=models.SET_NULL, blank=True, null=True)
    ...
    estado = models.ForeignKey(EstadoDoDocumento, on_delete=models.SET_NULL, null=True, blank=True)
...
class Pendencia(models.Model):
    estagiario = models.ForeignKey(Estagiario, on_delete=models.SET_NULL, null=True)
    tipo_de_pendencia = models.ForeignKey(TipoDePendencia, on_delete=models.SET_NULL, null=True)
...
class Contatamento(models.Model):
    ...
    tipo_de_contatamento = models.ForeignKey(TipoDeContatamento, on_delete=models.SET_NULL, blank=True, null=True)
...
class Foto(models.Model):
    ...
    item_fotografado = models.ForeignKey(ItemFotografado, on_delete=models.SET_NULL, null=True)
...
class AvaliacaoDeEstagiario(models.Model):
    operacao = models.ForeignKey(AvaliacaoDeTodosOsEstagiarios, on_delete=models.SET_NULL, null=True)
    estagiario = models.OneToOneField(Estagiario, on_delete=models.SET_NULL, null=True)
